...
import { Shirt, BarChart3, Calendar, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 pt-16 pb-24">
        <div className="text-center max-w-3xl mx-auto fade-in">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
            Transform how you dress with smart organization, style insights, 
            and wardrobe management tailored just for you.
          </p>
      ...
      <footer className="relative z-10 border-t border-gray-200/50 py-8 mt-12">
        <div className="container mx-auto px-6 text-center text-sm text-gray-500">
          2026 Wardrobe. All rights reserved.
        </div>
      </footer>
    </div>
  );
